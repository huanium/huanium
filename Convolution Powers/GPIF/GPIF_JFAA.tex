...
\AtEndEnvironment{example}{\phantom{}\hfill$\triangle$}
\smartqed


\spnewtheorem*{subproof}{Proof}{\it}{\normalfont}
\renewcommand*{\qedsymbol}{\hfill$\mathbin{/\mkern-6mu/}$}

% get subproof to drop "Proof" if name declared
\spnewtheorem*{xsubproof}{}{\itshape}{\rmfamily}
\newcommand\xsubprooftitle{}
\renewenvironment{subproof}[1][\proofname]{\renewcommand\xsubproofname{#1}\xsubproof}{\endxsubproof}

% get proof to drop "Proof" if name declared
\spnewtheorem*{xproof}{}{\itshape}{\rmfamily}
...
\newcommand\OdR{\mbox{O}(\mathbb{R}^d)} %Orthogonal
...
\journalname{Journal of Fourier Analysis and Applications }
...
\titlerunning{A generalized polar integration formula}      
...
\institute{
H. Bui \at
\email{\href{mailto:hqbui21@colby.edu}{hqbui21@colby.edu}} 
\and
E. Randles \at
Department of Mathematics and Statistics, Colby College \\
%Tel.: +123-45-678910\\
\email{\href{mailto:erandles@colby.edu}{erandles@colby.edu}}%  \\
%\emph{Present address:} of E. Randles  %  if needed
}
...
\keywords{Polar-coordinate Integration Formula \and  Spherical Measure \and Oscillatory Integrals \and Convolution Powers}
%\PACS{PACS code1 \and PACS code2 \and more}
\noindent 
\subclass{Primary 28A25 \and 58C35 \and Secondary 42B20 \and 42A85}
\end{abstract}
...
\begin{figure}[!htb]
    ...
    \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[scale=0.4]{Fig2a.eps}
    \vspace{-10pt}
...
\begin{equation*}
    ...
    =  \frac{\tau^3\zeta^2}{2304} - \frac{\tau^3\zeta^4}{27648} + \frac{\tau^4\zeta^4}{18432} +  \frac{\tau^4\zeta^4}{18432} + \cdots
\end{equation*}
...
%%%%%% END OF PROOF OF INTEGRATION FORMULA %%%%%%%%
%%%%%% END OF PROOF OF INTEGRATION FORMULA %%%%%%%%
%%%%%% END OF PROOF OF INTEGRATION FORMULA %%%%%%%%
...
\vspace{.4cm}
\noindent{\bf Acknowledgement:} We thank Laurent Saloff-Coste for helpful discussions.
