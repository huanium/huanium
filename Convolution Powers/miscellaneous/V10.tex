...
\int_{\mathbb{R}^d}f(x)\,dx=\int_{\mathbb{S}}\left(\int_0^\infty f(r\eta)r^{d-1}\,dr\right)\,\Theta(d\eta)=\int_0^\infty\left(\int_\mathcal{S}f(r\eta)\Theta(d\eta)\right)r^{d-1}\,dr.
\end{equation}
...
\end{definition}
\begin{comment}\begin{definition}\label{def:Types}
...
\end{equation}
where $\alpha_{\xi_0}\in\mathbb{R}^d$, $P_{\xi_0}$ is a positive-homogeneous polynomial with $R_{\xi_0}=\Re P_{\xi_0}$ and, for some $E\in \Exp(P_{\xi_0})$, $\widetilde{P}_{\xi_0}$ is subhomogeneous with respect to $E$. By a slight abuse of notation, we will write $\mu_{\xi_0}=\mu_{P_{\xi_0}}$.
...
\begin{equation*}
    \Gamma_{\xi_0}(\xi)=i\alpha_{\xi_0}\cdot\xi +i\left(Q_{\xi_0}(\xi)+\widetilde{Q}_{\xi_0}(\xi)\right)-\left(R_{\xi_0}(\xi)+\widetilde{R}_{\xi_0}(\xi)\right)
\end{equation*}
where $\alpha_{\xi_0}\in\mathbb{R}^d$; $Q_{\xi_0}$ and $R_{\xi_0}$ are real-valued polynomials for which $\abs{Q_{\xi_0}}$ and $R_{\xi_0}$ are positive homogeneous; $\widetilde{Q}_{\xi_0}$ and $\widetilde{R}_{\xi_0}$ are real-valued continuously differentiable functions on $\mathcal{U}$; and for $Q_{\xi_0}$, $\widetilde{Q}_{\xi_0}$, $R_{\xi_0}$, and $\widetilde{R}_{\xi_0}$ the following compatibility condition is satisfied: There is $k>1$ and $E\in\Exp(\abs{Q_{\xi_0}})$ for which $\widetilde{Q}_{\xi_0}$ is strongly subhomogeneous with respect to $E$, $R_{\xi_0}$ is homogeneous with respect to $E/k$ and $\widetilde{R}_{\xi_0}$ is strongly subhomogeneous with respect to $E/k$.  By a slight abuse of notation, we write $\mu_{\xi_0}=\mu_{\abs{Q_{\xi_0}}}$.
\end{enumerate}
