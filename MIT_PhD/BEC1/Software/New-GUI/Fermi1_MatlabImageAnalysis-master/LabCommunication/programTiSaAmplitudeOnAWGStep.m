function programTiSaAmplitudeOnAWGStep(startV,endV)
% 6/13/19 hard code startV, endV< 190mV
% % startV=min(startV,0.19);
% % endV=min(endV,0.19);
% % disp('Warning 6/13/19: cannot go above 190mV; bypassing lockbox');
% disp(num2str(endV))
% %%%%%%%%%%%%%%%
...
nsamples=1;
sinperiod = 100;
xvals = 1/nsamples:1/nsamples:sinperiod; %10 == one period = 1ms, width of 



voltageRamp = [startV,endV*ones(1,25000)];
...
fprintf(AWG,'%s', sprintf('FREQ %.7f', 1000/(5000)));
