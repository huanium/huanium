...
% Last Modified by GUIDE v2.5 08-Oct-2021 15:31:59
...
% Hint: place code in OpeningFcn to populate x1


% --- Executes during object creation, after setting all properties.
function x_XSlice_CreateFcn(hObject, eventdata, handles)
% hObject    handle to x_XSlice (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate x_XSlice
