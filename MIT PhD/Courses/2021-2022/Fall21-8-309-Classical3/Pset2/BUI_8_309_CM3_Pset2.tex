...
\noindent \textbf{6. A Falling Ladder for 8.309 students} 
	\begin{enumerate}[label = (\alph*)]
		...
		\end{align*}
		At $\theta_c$, many of the above quantities are known: 
		\begin{align*}
		blah
		\end{align*}
		Moreover, by definition, we can write the left-hand side entirely in terms of $\dot \theta$ and $\theta$:
		\begin{align*}
		blah
		\end{align*}
		Putting everything together and solving for $\dot\theta$ gives
		\begin{align*}
		...
		\end{align*}
		\textcolor{red}{By hook or by crook we will show that $\lambda_2$ also never vanishes.}
