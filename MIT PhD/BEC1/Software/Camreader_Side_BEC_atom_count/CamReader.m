...
% Last Modified by GUIDE v2.5 19-May-2022 11:34:27
...
handles.outfolder=['R:\Images\', YearString, '\' ,MonthString,'\',DateString];
set(handles.OutFolder,'String',handles.outfolder);
handles.secoutfolder=['R:\Images\Delete My Contents'];
...
handles.satcount=str2double(get(handles.SatCount,'string'));
...
if get(handles.Counting,'value') % do the atom counting
    ...
    atomnumberG=0; %FindAtomNumberGaussian(atomnumbermap);
...
% --- Executes on button press in BEC_count.
function BEC_count_Callback(hObject, eventdata, handles)
% hObject    handle to BEC_count (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

axial=str2double(get(handles.axial_trap_freq,'string'));
radial=str2double(get(handles.rad_trap_freq,'string'));
umpx=str2double(get(handles.um_per_px,'string'));
tof=str2double(get(handles.BEC_TOF,'string'))/1000; % convert ms to s
r=str2double(get(handles.BEC_diameter,'string'))/2;

hbar = 1.054e-34;
m = 23*1.67e-27;
omega = (2*pi*radial*2*pi*radial*2*pi*axial)^(1/3);
a = 85 * 0.529e-10;

BEC_cts = ((m/2*(2*pi*radial)^2/(1 + (2*pi*radial*tof)^2))...
    *(umpx*10^(-6)*r)^2)^(5/2)/(15*hbar^2*m^(1/2)*omega^3*a/2^(5/2)); 

set(handles.BEC_atom_counts,'string',num2str(BEC_cts, '%10.3e' ));

guidata(hObject,handles);



function BEC_diameter_Callback(hObject, eventdata, handles)
% hObject    handle to BEC_diameter (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of BEC_diameter as text
%        str2double(get(hObject,'String')) returns contents of BEC_diameter as a double


% --- Executes during object creation, after setting all properties.
function BEC_diameter_CreateFcn(hObject, eventdata, handles)
% hObject    handle to BEC_diameter (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function BEC_TOF_Callback(hObject, eventdata, handles)
% hObject    handle to BEC_TOF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of BEC_TOF as text
%        str2double(get(hObject,'String')) returns contents of BEC_TOF as a double


% --- Executes during object creation, after setting all properties.
function BEC_TOF_CreateFcn(hObject, eventdata, handles)
% hObject    handle to BEC_TOF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function rad_trap_freq_Callback(hObject, eventdata, handles)
% hObject    handle to rad_trap_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of rad_trap_freq as text
%        str2double(get(hObject,'String')) returns contents of rad_trap_freq as a double


% --- Executes during object creation, after setting all properties.
function rad_trap_freq_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rad_trap_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function BEC_atom_counts_Callback(hObject, eventdata, handles)
% hObject    handle to BEC_atom_counts (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of BEC_atom_counts as text
%        str2double(get(hObject,'String')) returns contents of BEC_atom_counts as a double


% --- Executes during object creation, after setting all properties.
function BEC_atom_counts_CreateFcn(hObject, eventdata, handles)
% hObject    handle to BEC_atom_counts (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function um_per_px_Callback(hObject, eventdata, handles)
% hObject    handle to um_per_px (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of um_per_px as text
%        str2double(get(hObject,'String')) returns contents of um_per_px as a double


% --- Executes during object creation, after setting all properties.
function um_per_px_CreateFcn(hObject, eventdata, handles)
% hObject    handle to um_per_px (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function axial_trap_freq_Callback(hObject, eventdata, handles)
% hObject    handle to axial_trap_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of axial_trap_freq as text
%        str2double(get(hObject,'String')) returns contents of axial_trap_freq as a double


% --- Executes during object creation, after setting all properties.
function axial_trap_freq_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axial_trap_freq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
