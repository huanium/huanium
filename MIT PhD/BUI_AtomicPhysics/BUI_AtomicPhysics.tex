...
0
\end{equation*}
where we have used $\mu = g\abs{\psi_0}^2$. From the determinant of this matrix, we can find the relation between the angular frerquency of the small oscillations $\omega$ and the magnitude of their wavevector $k$:
\begin{equation*}
