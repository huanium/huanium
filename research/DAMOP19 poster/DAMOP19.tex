...
\caption{\normalfont{(a) Rydberg excitation, trapping, and (b) d-d excitation schemes.}}
\label{Excitation}
\end{center}
\end{figure}
...
\caption{\normalfont{ 33d\textsubscript{5/2}$\rightarrow$34d\textsubscript{5/2} DC Stark shifts and field nulling} as a function of voltages on the rods.}
\label{nulling}
\end{center}
\end{figure}
...
\caption{\normalfont{Delay ($T$) scans at different $\omega_0$'s. Each corresponds to the same field-free interval \textrm{179,483.467(10) MHz}}.}
\label{Ramsey}
\end{figure}
