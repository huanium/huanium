...
Menu "Macros"
	...
	"Transition Analysis Ramsey...", TransitionAnalysis()
End
...
String filename_delay = "rams_000_delay"
String filename_Rydberg1 = "rams_000_Rydberg1"
String filename_Rydberg1_sigma = "rams_000_Rydberg1_sigma"
String filename_Rydberg2 = "rams_000_Rydberg2"
String filename_Rydberg2_sigma = "rams_000_Rydberg2_sigma"
String filename_RydbergT = "rams_000_RydbergT"
String filename_RydbergT_sigma = "rams_000_RydbergT_sigma"

String filename_TransFrac = "rams_000_TransFrac"
...
filename_delay[5,7] = filename[5,7]
...
//Create waves with meaningful names
	Duplicate/O $w0, $filename_delay; KillWaves $w0
	Wave delay = $filename_delay
	delay*=0.001   // convert nanosecond to microsecond
...
//	variable df = (moffset[1] - moffset[0])
	variable df = (delay[numpnts(delay)] - delay[0])/(numpnts(delay)-1)
	variable fstart = delay[0]
...
//	ModifyGraph tick=2
	...
	Display $filename_TransFrac vs delay
