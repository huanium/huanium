...
def run(iter, rate, wave1, wave2, wave3, wave4, digits):
    ...
    # analog channels
    ao_0 = task_ao.ao_channels.add_ao_voltage_chan('Dev1/ao0')
    ao_1 = task_ao.ao_channels.add_ao_voltage_chan('Dev1/ao1')
    ao_2 = task_ao.ao_channels.add_ao_voltage_chan('Dev1/ao2')
    ao_3 = task_ao.ao_channels.add_ao_voltage_chan('Dev1/ao3')
