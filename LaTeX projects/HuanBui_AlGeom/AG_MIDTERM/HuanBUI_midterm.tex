...
\begin{enumerate}[(a)]
	...
	%(If you prefer to avoid the language of ``gluing,'' you can express it as taking the disjoint union of two copies of $\mathbb{A}^1(k)$ and then passing to the quotient with respect to an equivalence relation.) 
\end{enumerate}
