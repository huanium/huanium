...
\begin{align}
\lp (\hat{p_1} - \hat{p_2}) - z_{\alpha/2}\sqrt{\f{\hat{p_1}(1-\hat{p_1})}{n_1}} + \f{\hat{p_1}(1-\hat{p_1})}{n_1} \rp
\end{align}
where $\alpha_{0.05} = 1.644854$. Plugging in numbers, we find
\begin{align}
\lp 0.5-0.4 - 1.644854\sqrt{ \f{(0.5)(0.5)}{100} + \f{(0.4)(0.6)}{100} },\right.\nn\\ \left. 0.5-0.4 + 1.644854\sqrt{ \f{(0.5)(0.5)}{100} + \f{(0.4)(0.6)}{100} }  \rp = \boxed{ (-0.01513978,0.2151398) }
\end{align}\qed
...
&= \int^{2\ln(0)}_0 \f{1}{4}\xi e^{\xi/2}\,d\xi\nn\\
...
\end{align}
And so, for a given $\mu > \mu_0$, the power function of the one-sided test is larger than the power function of the two-sided test. \\

\noindent Pictorally,
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.15]{ta}
	\includegraphics[scale=0.15]{ta2}
\end{figure}
