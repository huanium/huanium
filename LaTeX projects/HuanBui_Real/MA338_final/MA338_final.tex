...
\begin{enumerate}[(a)]
	...
	Consider the subsequence $\{b_n\}$ of $\{a_n\}$ consisting only of the terms of $a_n$ where $n$ is odd and the series
	\begin{align*}
	...
	\begin{align*}
	\int_1^\infty \f{1}{2n-1}\,dn = \lim_{k\to \infty}\int^k_1 \f{1}{2n-1}\,dn = \f{1}{2}\ln (2k-1) \to \infty
	\end{align*}
	...
	\end{align*}
	which also goes to 0 as $n\to \infty$. So, because  $na_{n} \to 0$ as $n\to \infty$ for all $n$ (odd or even), $\lim_{n\to \infty} na_n = 0$. \hfill$\square$
