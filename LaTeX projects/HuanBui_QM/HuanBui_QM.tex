...
\begin{align}
\f{d}{db}^n \exp\lp -\f{a}{2}x^2 + bx \rp \bigg\vert_{b=0} = x^n \exp\lp -\f{a}{2}x^2 + bx \rp\bigg\vert_{b=0} = x^n \exp\lp -\f{a}{2}x^2\rp,
\end{align}
...
Thus we have finally evaluated $\Z(J)$:
\begin{align}
...
\subsubsection{Wick contraction}
