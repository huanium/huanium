...
\begin{align}
d^3k = k^2 \sin \theta \,dk,d\theta\,d\phi \sim  k^2 \, d(\cos\theta)\,d\phi.
\end{align}
Thus,
\begin{align}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.5]{feynman-1}
	\caption{From Zee}
\end{figure}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.5]{feynman-2}
	\caption{From Zee}
\end{figure}
...
\subsubsection{A child problem: Propagation from here to there}
...
\end{align}
What about the $\lambda/4!$ integral? 
