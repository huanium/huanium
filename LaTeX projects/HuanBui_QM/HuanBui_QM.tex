...
\subsubsection{Bypassing Maxwell}




\subsubsection{Bypassing Einstein}

\subsubsection{Why we fall}

\subsubsection{The universe}

\subsubsection{Time differs from space by a sign}

\subsubsection{Degrees of freedom}

\subsection{Invserse Square Law \& Planck Mass}

\subsubsection{Inverse square law}
