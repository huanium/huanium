...
\section{Path Integral in Quantum Field Theory - Primer}
...
\end{align}
Again, we should worry about the pole at $k^2 = m^2$. 
...
Now, consider the case where we have two sources $J_1, J_2$ in spacetime such that $J(x) = J_1(x) + J_2(x)$. Then $W(J)$ contains four terms involving $J_1$ and $J_2$. One of the terms contains $J_2^* J_1$:
\begin{align}
