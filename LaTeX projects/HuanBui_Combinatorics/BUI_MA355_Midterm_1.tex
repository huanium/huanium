...
\begin{enumerate}[(a)]
	...
	\begin{itemize}
		...
		\item Send the remaining students of Group 2 into the three new groups that don't have any from Groups 1 and 2 ($3\times 2!$ ways).
		
		\item Now, there is one new group with two students (the rest have three each). Send one student from the remaining two of Group 1 into this new group ($2$ ways). 
	...
	\textbf{Answer:} Following a similar argument (starting with 12 students and picking 3 students for each subsequent group) and notice that we now have four groups of three, we must replace the $1/3!$ factor by $1/4!$: 
	\begin{equation*}
