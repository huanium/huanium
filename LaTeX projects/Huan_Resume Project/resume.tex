...
\begin{document}
	...
	\noindent \textbf{Undergraduate Researcher, Perimeter Institute for Theoretical Physics} \hfill May\textemdash Aug 2020 \\ 
	\noindent PI: {TBA}, TBA
	\begin{itemize}[noitemsep, nolistsep]
		\item Topic: \textit{TBA}
	\end{itemize}
...
%	\end{itemize}
	...
	\noindent \textbf{Personal Website/Archive}, \href{https://huanqbui.com}{\texttt{huanqbui.com}}: notes from class and independent readings plus other projects.\\ %\href{https://github.com/huanium/huanium}{\underline{Github}} 
