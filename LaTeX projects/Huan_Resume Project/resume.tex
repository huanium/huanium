...
\begin{document}
	...
	\vspace{-7pt}
			...
			Bachelor of Arts, {Majors}: Physics \& Mathematics, {Minor}: Statistics \hfill Class rank: 1/560\\
			\vspace{-7pt}
	...
	\vspace{-7pt}
	\noindent \longunderline{\normalsize{{\color{colby}{\textbf{RESEARCH EXPERIENCE}}}}}
	\\ \vspace{-7pt}
...
%	\end{itemize}
	...
	\noindent \textbf{Undergraduate Researcher, Perimeter Institute for Theoretical Physics} \hfill \textit{May\textemdash Aug 2020} \\ 
	...
	\begin{itemize}[noitemsep, nolistsep]
		\item Convolution powers of complex functions on $\mathbb{Z}^d$ whose attractors involve oscillatory integrals
		...
		\item Prove a new local limit theorem (in preparation)
	\end{itemize}
...
\noindent \textbf{Applied Mathematics}: Advisor: Evan Randles; Convolution powers of complex functions \& harmonic analysis\\
	...
	\vspace{-7pt} \noindent \longunderline{\normalsize{{\color{colby}{\textbf{HONORS, AWARDS, FUNDS}}}}}\\ \vspace{-7pt}
		...
		\noindent \textbf{William A. Rogers Prize in Physics and Astronomy}, Colby College  \hfill \textit{May 2020}	\\
		\noindent \textbf{Phi Beta Kappa} (US national academic honor society) \hfill \textit{Apr 2020}	\\
		\noindent \textbf{Mu Sigma Rho} (US national statistics honor society) \hfill \textit{Apr 2020}	\\
		\noindent \textbf{Honorable Mention,}  COMAP Mathematical Contest in Modeling, \textit{S' 20}\\
