...
\begin{document}
	...
	\end{itemize}
	\noindent \textbf{Experimental physics}\hfill Sep 2019 \textemdash Present
	\begin{itemize}[noitemsep, nolistsep]
		\item Advisor: Charles Conover. Topic: Lifetime measurements of ultracold potassium $4p$.
	\end{itemize}
	\noindent \textbf{Theoretical physics}\hfill Sep 2019 \textemdash Present
	\begin{itemize}[noitemsep, nolistsep]
		\item Advisor: Robert Bluhm. Topic: Massive gravity\\
	\end{itemize}
	...
	\noindent Colby Ultimate Frisbee, Colby Photography Club, Colby Society of Physics Students (board member)
