...
\begin{document}
	...
	\textbf{Researcher Assistant} (anticipated),  \textit{Joint Quantum Institute\textemdash Univ. of Maryland \&  NIST}\hfill Summer 2019
	...
	\section*{\normalsize{{\color{colby}Skills}}}
		\begin{tabular}{lp{13.5cm}lp{8in}}
			...
			\textbf{Computing} & IGOR Pro (programming, analysis \& modeling), R, Python, Mathematica, \LaTeX{}, Adobe Illustrator, Ubuntu, Windows, MacOS, C++ (beginner), HTML \& CSS (beginner).\\
