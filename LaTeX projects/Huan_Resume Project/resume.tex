...
\begin{document}
	...
	\section*{\normalsize{{\color{colby}Education}}}
		\begin{tabular}{lp{12.5cm}lp{8in}}
			\textbf{B.A.} (\textit{anticipated}) & \textit{Colby College}, 2017\textemdash 2021, GPA: 4.12/4.00\\ & Majors: Physics \& Mathematics. Minor: Statistics\\
		\end{tabular}
	...
	\section*{\normalsize{{\color{colby}Conferences}}}
		\begin{tabular}{lp{13.5cm}lp{8in}}
			...
			\textbf{CLAS 2019} & Matrices and Error Correction in Coding Theory (\textit{anticipated})\\
