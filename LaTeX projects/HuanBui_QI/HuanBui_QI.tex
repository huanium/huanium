...
\newpage
\section{Cbits \& their states}
\newpage
\section{Reversible operations on Cbits}
\newpage
\section{Manipulating operations on Cbits}
\newpage
\section{Qbits \& their states}
\newpage
\section{Reversible operations on Qbits}
\newpage
\section{Circuit diagrams}
\newpage
\section{Measurement gates and the Born rule}
\newpage
\section{The generalized Born rule}
\newpage
\section{Measurement gates and state preparation}
\newpage
\section{Constructing arbitrary 1- and 2-Qbit state}
\newpage
\section{Summary}
\newpage
