...
%	
%	\begin{proof}
%		$\Lambda \to \X$ defined by $(x,F) \mapsto x$. If Cauchy net, then take $\epsilon > 0, d \in \mathcal{U}$. By Cauchyness, there exists $F_0\in \F$ such that $\forall F\in \F, F \geq F_0$, and $\forall x\in F_0, z\in \F$, $d(x,z) < \epsilon$.  Fix $x_0 \in F_0$. Then $B_d(x_0,\epsilon) \supseteq F_0$. Therefore, $B_d(x_0, \epsilon)\in \F$. So $\F$ is Cauchy.
%	\end{proof}
%\end{exercise}
