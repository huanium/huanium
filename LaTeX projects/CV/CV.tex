...
& $\bullet$ Quantum many-body physics on quantum hardware. \vspace{-4pt}
 \begin{enumerate}
	...
	\item[$-$] Found numerically that ground states of the disordered 1D quantum Ising model can be represented exactly by a depth $L/2$ nonuniform-coupling QAOA ansatz
 \end{enumerate}\\
