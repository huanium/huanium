...
\begin{itemize}
	...
	\item Quantum gas microscope of fermionic dipolar molecules of $^{23}$Na$^{40}$K
...
\begin{enumerate}
	\setlength\itemsep{-4pt}
 	\item Chuang A. Y., \textbf{Bui H. Q.}, Christianen A., Zhang Y., Ni Y., Ahmed-Braun D., Robens C., Zwierlein M. W. {Observation of a Halo Trimer in an Ultracold Bose-Fermi Mixture}. Submitted to Physical Review X.  \href{https://arxiv.org/abs/2411.04820}{\texttt{arxiv:2411.04820}}
...
\begin{itemize}
\setlength\itemsep{-4pt}
\item Experimental atomic, molecular, and optical physics: Quantitative analysis of images for spatial profile and densities of ultracold atomic gases; Develop graphical software and scripts for experimental control and data acquisition and analysis; Design and building a low-cost, low-loss, and high directivity microwave antenna. Design and build high-stability and high-power optical systems for laser cooling and trapping. 
\item \noindent {Programming/Scripting Languages:} Python (numpy, scipy, pandas), MATLAB, Mathematica, HTML \& CSS, \LaTeX{}, R
\item \noindent {Softwares:} Ansys Zemax OpticStudio, Ansys HFSS, MATLAB, SolidWorks, IGOR Pro, NI-MAX, PicoHarp \& TimeHarp, MS Office,  Adobe Illustrator, Adobe Lightroom, Inkscape
\end{itemize}
