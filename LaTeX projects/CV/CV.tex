...
\noindent \begin{longtable}{ l p{14.7cm}   }
  ...
  \large{Education}    	& \\ 
	 					...
	 					& \\
	 					& $\bullet$ \textbf{Mathematics:} applied mathematics/analysis and ODE (thesis), functional analysis, real analysis, complex analysis, algebraic geometry, abstract algebra, matrix analysis, linear algebra, ordinary differential equations, partial differential equations, probability theory, vector calculus, honors calculus\\   \vspace{-9pt}
	 					& \\ 
...
\large{Research}      
& \\  
& \textbf{Undergraduate Researcher, Perimeter Institute for Theoretical Physics}, \textit{May 2020\textendash Present}\\
...
\large{Abstracts/}   	& \\
\large{Conferences/}	& \textbf{Perimeter Institute Undergrad Intern Symposium,} \textit{July 2020}\\
\large{Presentations}	& Measurement-assisted variational simulation of non-trivial quantum states (\href{https://huanqbui.com/LaTeX 20projects/HuanBui_Perimeter/Presentation/MBQC_as_Simulation.pdf}{{pdf}}) \\
	&\\
