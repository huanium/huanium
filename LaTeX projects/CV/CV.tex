...
\begin{itemize}
\setlength\itemsep{-4pt}
\item Experimental Atomic, Molecular, and Optical physics: Quantitative analysis of images of ultracold atomic gases; Automated experimental optimizations with MLOOP, Built GUIs (Python and MATLAB) for experimental control and data acquisition; Modeled and built a low-cost and efficient resonant microwave antenna; Designed and built interferometrically stable optical systems for manipulating ultracold atoms with laser light; Built a high-NA imaging system for atom-resolved microscopy.
