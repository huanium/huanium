...
\fbox{?} What is the distribution which $S_n = X_1 + X_2 + \dots + X_n$ follows?
\begin{align*}
...
\end{align*}
\pause
\centering\textcolor{purple}{\fbox{\textbf{How does $\phi^{(n)}$ behave as $n\to \infty$?}}}
...
%	\pause
%	\item \textbf{Global estimate:} There are positive constants $C$ and $M$ for which
%	\begin{equation*}
...
\begin{center}
	\textcolor{blue}{\fbox{\textbf{What if positivity is dropped?}}}\\
\end{center}
...
\begin{theorem}[Global decay estimate, Randles \& Saloff-Coste -- 2015\nocite{randles_convolution_2015}]
...
%\frametitle{Global decay estimate for $\abs{\phi^{(n)}}$: In $1$ dimension}
%
%\underline{Examples}: $P$ doesn't have to be smooth
%\begin{figure}
%	\centering
%	\begin{subfigure}{0.49\textwidth}
%		\centering
...
\begin{theorem}[Global decay estimate, Randles \& Saloff-Coste -- 2017\nocite{randles_convolution_2017}]\label{thm:d}
