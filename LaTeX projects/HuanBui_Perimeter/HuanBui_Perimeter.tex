...
\begin{enumerate}
	...
	\begin{proof}
		...
		\end{align}		
		With this, we can write out the approximation as in the problem.  
	\end{proof}
	...
	\begin{proof}
		Note that when $n$ is odd, the corrections vanish. So, we only pay attention to the even $n$, the smallest of which is $n=4$.
	\end{proof}
	
	
	\item Determine the value of $a$ in equation (2) by making a change of variables.
	\begin{proof}
		Now, making the substitution $y = (x- x_c)/\sqrt{\hbar}$. with this, we get $a=1$. 
	\end{proof}
\end{enumerate}
