...
\begin{exmp}
	...
	which says
	\begin{align*}
	&\f{1}{\pi}\int^{\pi}_0 \cos(n\theta)\,d\theta = 0  = a_n+ \alpha_n\\
	&\f{1}{\pi}\int^{\pi}_0 2\cos(n\theta)\,d\theta = 0 = a_n 2^n + \alpha_n 2^{-n}
	\end{align*}
	and
	\begin{align*}
	&a_n = 0\\
...
\begin{exmp}
	...
	which says
	\begin{align*}
	&\f{1}{\pi}\int^{\pi}_0 \sin(2\theta)\cos(n\theta)\,d\theta = a_n + \alpha_n\\
	&\f{1}{\pi}\int^{\pi}_0 \sin(\theta)\cos(n\theta)\,d\theta = a_n 2^n + \alpha_n 2^{-n}
	\end{align*}
	and
	\begin{align*}
	&a_n = 0\\
	...
	Similarly, 
	\begin{align*}
	&\f{1}{\pi}\int^{\pi}_0 \sin(2\theta)\sin(n\theta)\,d\theta = a_n + \alpha_n\\
	&\f{1}{\pi}\int^{\pi}_0 \sin(\theta)\sin(n\theta)\,d\theta = a_n 2^n + \alpha_n 2^{-n}.
	\end{align*}
...
% Lesson 33, Problem 2
% Lesson 34, Problems 1,2,3
% Lesson 35, Problem 1,2
