...
\end{align*}
\newpage
\chapter{Separation of Variables - First method of solution}
...
%Mar 4 2019%
\newpage
\chapter{Transforming Hard Equations into Easier Ones}
...
R(r) = C_0+D_0\ln(r).
\end{align*}
So we expect solutions %April 22, 2019%
\begin{align*}
...
\begin{enumerate}
	...
	\end{align*}
	So, for example, if we were to charge a metal sphere with 10 volts:
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.75]{ball.png}
		\caption{Sketch by Jerry Bao}
	\end{figure}
	To find the interior electric field, we solve Laplace's equation 
	\begin{align*}
	\begin{cases}
	\laplacian u = 0.\\
	u(r) = 10 \text{V}
	...
	\vec{E} = \nabla u(r,\theta,\phi) = 0
	\end{align*}
	everywhere inside the ball.
	
	
	\item \textbf{Spherical shells:} 
	$\,$
	\begin{figure}[htb!]
		\centering
		\includegraphics[scale=1]{shell.png}
		\caption{Spherical shells by Jerry Bao}
	\end{figure}
