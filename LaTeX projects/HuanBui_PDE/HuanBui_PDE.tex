...
\begin{exer*}\textbf{2. Problem 2, Lesson 34} 
	...
	\begin{sln*}\textbf{2. }
		...
		\begin{enumerate}
			\item $u(1,\theta) = 1 \implies u(r,\theta) = 1$.
			\item $u(1,\theta) = 1 + \cos(3\theta) \implies u(r,\theta) = 1 + \f{1}{r^3}\cos(3\theta)
			$.
			\item $u(1,\theta) = \sin(\theta) + \cos(3\theta) \implies u(r,\theta) = \f{1}{r}\sin(\theta) + \f{1}{r^3}\cos(3\theta)$.
			\item $u(1,\theta) = \begin{cases}
			1 \hspace{0.5cm} 0 \leq \theta < \pi\\
			0 \hspace{0.5cm} \pi \leq \theta < 2\pi
			\end{cases}$, then
...
\begin{exer*}\textbf{5. Problem 2, Lesson 35} 
	...
	\begin{sln*}\textbf{5. } For $x = \cos\phi$,
		...
		&= \f{\cos\phi}{-\sin\phi} \Phi' + \Phi'' + n(n+1)\Phi \\
		&= -\cos\phi\f{d\Phi}{dx} + \f{dx}{d\phi}\f{d}{dx}\lp  \f{d\Phi}{dx}\f{dx}{d\phi} \rp + n(n+1)\Phi\\
